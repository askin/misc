...
<li class="<?php if ($comment->comment_author_email == "") echo 'mycomment'; else echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
		...
		<p style="margin-bottom:5px; border-bottom:1px #fff dotted; padding-bottom:5px;">By <strong><?php comment_author_link() ?></strong> on <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('M j, Y') ?></a> | <a href="#respond">Reply</a><?php edit_comment_link('Edit',' | ',''); ?></p>
